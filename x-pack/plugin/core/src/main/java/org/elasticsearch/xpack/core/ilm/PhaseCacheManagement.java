...
public final class PhaseCacheManagement {
    ...
    public static ClusterState refreshPhaseDefinition(final ClusterState state, final String index,
        ...
        ClusterState.Builder newClusterStateBuilder = ClusterState.builder(state);
        newClusterStateBuilder.metadata(Metadata.builder(state.getMetadata())
            .put(IndexMetadata.builder(state.getMetadata().index(idxMeta.getIndex()))
